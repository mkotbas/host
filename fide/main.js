...
function toggleSpecialManagerUI(selectElement) {
    ...
    if (selectElement.value === 'product_list') {
        ...
        // Standart soru ise özel konteyner classlarını temizle
...
// Kaldırılan fonksiyon: function toggleProductManager(selectElement) { /* Bu fonksiyon artık kullanılmıyor, toggleSpecialManagerUI'a entegre edildi */ }
